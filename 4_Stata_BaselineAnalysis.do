...
* Farmers: Median return to labour of biofuel tree cultivation (family land, family labour) - Low yield 
twoway (line MedRetLab_LY_1 year if MedRetLab_LY_1 >= 5, lwidth(medthick) lcolor(midblue) lpattern("_-")) ///
	|| (line MedRetLab_LY_23 year if MedRetLab_LY_23 >= 5, lwidth(medthick) lcolor(orange) lpattern("-")) ///
	|| (line MedRetLab_LY_45 year if MedRetLab_LY_45 >= 5, lwidth(medthick) lcolor(gs10) lpattern(solid)) ///
	|| (line MedRetLab_LY_67 year if MedRetLab_LY_67 >= 5, lwidth(medthick) lcolor(gold) lpattern("_")) ///
...
* Farmers: Median return to labour of biofuel tree cultivation (family land, family labour) - High yield 
twoway (line MedRetLab_HY_1 year if MedRetLab_HY_1 >= 5, lwidth(medthick) lcolor(midblue) lpattern("_-")) ///
	|| (line MedRetLab_HY_23 year if MedRetLab_HY_23 >= 5, lwidth(medthick) lcolor(orange) lpattern("-")) ///
	|| (line MedRetLab_HY_45 year if MedRetLab_HY_45 >= 5, lwidth(medthick) lcolor(gs10) lpattern(solid)) ///
	|| (line MedRetLab_HY_67 year if MedRetLab_HY_67 >= 5, lwidth(medthick) lcolor(gold) lpattern("_")) ///
	, ytitle("Return to labour (INR/hour)") xtitle("Years after planting") yline(0) ///
	legend(label(1 "Farmer-oil chain") label(2 "Farmer-BP chains") label(3 "BP chains") label(4 "Farmer-Industry chains")) xtick(5 15 25) ///
